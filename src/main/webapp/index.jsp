  ...
  <nav class="navbar navbar-light bg-primary">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">
        <img src="img/network.png" alt="" width="80" height="80" >
      </a>
      <h2>Управление персоналом</h2>
    </div>
  </nav>
  <div class="container"> <br><br><br>
    <div class="list-group text-center py-3 px-3"> <h2>Функции системы</h2>
...
<script defer src="js/bootstrap.bundle.min.js"></script> </body>
</html>
